...
describe('storage.service - uploadFile', () => {
  ...
  it('still succeeds when folder contains double slashes (defensive branch)', async () => {
    ...
    const url = await uploadFile(Buffer.from('data'), 'image/jpeg', 'my//folder')
